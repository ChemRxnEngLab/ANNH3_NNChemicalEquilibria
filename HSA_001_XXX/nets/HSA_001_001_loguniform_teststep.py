...
model = EqNet(
    ...
    200,
    2,
    mean_in=dm_loguniform.X_mean,
    mean_out=dm_loguniform.y_mean,
    std_in=dm_loguniform.X_std,
...
print("Loguniform Net on loguniform dataloader")
Trainer.test(model, dm_loguniform)
print("Loguniform net on uniform dataloader")
