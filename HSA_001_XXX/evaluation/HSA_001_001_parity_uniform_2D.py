...
_range = ax.add_patch(trained_range)
...
plt.savefig(Path.cwd() / "figures" / "HSA_001_001_parity_uniform_NH3_2D.png", dpi=300)
...
ax.tick_params(direction="out")
plt.savefig(Path.cwd() / "figures" / "HSA_001_001_parity_uniform_H2_2D.png", dpi=300)
